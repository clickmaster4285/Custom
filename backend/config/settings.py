...
# track = log person on ByteTrack start/end; frame = legacy per-poll logging
DETECTION_LOG_MODE = os.getenv("DETECTION_LOG_MODE", "track").strip().lower()
DETECTION_TRACK_DEDUP_SECONDS = int(os.getenv("DETECTION_TRACK_DEDUP_SECONDS", "300"))
DETECTION_TRACK_MISS_POLLS = int(os.getenv("DETECTION_TRACK_MISS_POLLS", "3"))
PERSON_QR_AUTO_CREATE = os.getenv("PERSON_QR_AUTO_CREATE", "True").lower() in ("true", "1", "yes")
PERSON_FACE_MATCH_THRESHOLD = float(os.getenv("PERSON_FACE_MATCH_THRESHOLD", "0.38"))
