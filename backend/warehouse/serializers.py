...
class SeizureRecordSerializer(serializers.ModelSerializer):
    class Meta:
        model = SeizureRecord
        fields = [
            "id",
...
class WmsLifecycleEventSerializer(serializers.ModelSerializer):
    class Meta:
        model = WmsLifecycleEvent
        fields = [
            "id",
            "event_type",
            "detention_memo_id",
