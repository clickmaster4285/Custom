...
from .models import DepositAccountEntry, DetentionMemo, DetentionMemoAttachment
...
def get_memo_queryset():
    ...
    return (
        ...
        DetentionMemo.objects.prefetch_related("goods_lines", "attachments").all()
...
class DepositAccountEntryListAPIView(APIView):
    ...
    def get(self, request):
        ...
        qs = DepositAccountEntry.objects.select_related("detention_memo").all().order_by("-created_at")
...
class DepositAccountEntryUpdateAPIView(APIView):
    ...
    def patch(self, request, pk):
        ...
        entry = get_object_or_404(DepositAccountEntry.objects.select_related("detention_memo"), pk=pk)
