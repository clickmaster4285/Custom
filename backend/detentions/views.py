...
class DetentionMemoCreateAPIView(APIView):
    ...
    def post(self, request):
        ...
        try:
            from warehouse.wms_flow_service import log_memo_created

            log_memo_created(memo, performed_by=memo.created_by or "")
        except Exception:
            pass
...
class DepositAccountEntryCreateAPIView(APIView):
    ...
    def post(self, request):
        ...
        try:
            from warehouse.wms_flow_service import log_deposited
